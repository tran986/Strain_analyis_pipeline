...
a) Single nucleotide polymorphism (SNPs) within gene of a species AND/OR
b) Changes in gene presence and absence (aka function gain or loss) via copy number variants (CNV) of that gene in a species.
