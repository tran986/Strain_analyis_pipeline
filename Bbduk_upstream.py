...
rule all_bbduk:
  input:
    expand("data/processed/{DIRS}_{pair}.fastq",
       DIRS=dirsamples,
       pair=[1,2]),
...
rule bbduk:
 ...
 output:
  out1 = "data/processed/{dirsamples}_1.fastq",
  out2 = "data/processed/{dirsamples}_2.fastq",
 resources:
  time = "0:5:00",
  nodes = 1,
 shell:
  "/users/PAS1117/osu9664/eMicro-Apps/BBTools-38.69.sif bbduk.sh in={input.in1} in2={input.in2} out={output.out1} out2={output.out2}"
rule list_dir:
